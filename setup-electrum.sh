...
wget -N https://download.electrum.org/4.0.2/electrum-4.0.2-x86_64.AppImage
wget -N https://download.electrum.org/4.0.2/electrum-4.0.2-x86_64.AppImage.asc
...
gpg --verify electrum-4.0.2-x86_64.AppImage.asc
...
# Start tor and create ./electrum

nohup tor >/dev/null 2>&1 &
ln -f -s electrum-4.0.2-x86_64.AppImage electrum
